          ...
          <motion.div animate={shellControls}>
            <div className="mb-4 flex items-start justify-between gap-3">
              ...
              <button
                type="button"
                onClick={onClose}
                className={`rounded-sm border border-white/15 px-2 py-1 text-xs text-white/70 transition hover:border-cyan-300/40 hover:text-cyan-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-300/70 ${closeHintClass}`}
              >
                Close
              </button>
            </div>
