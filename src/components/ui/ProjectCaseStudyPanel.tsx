          ...
          <div className="flex shrink-0 flex-wrap items-center gap-2 border-t border-white/10 px-5 py-3">
            {project.github ? (
              <a
                ...
                className="rounded-sm border border-cyan-400/30 bg-cyan-500/10 px-3 py-1.5 text-xs tracking-wide text-cyan-100/90 transition hover:border-cyan-300/50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-300/70"
              >
                GitHub
              </a>
            ) : null}
            ...
            <button
              ...
              className="ml-auto rounded-sm border border-white/15 px-3 py-1.5 text-xs text-white/70 transition hover:border-cyan-300/40 hover:text-cyan-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-300/70"
            >
              Close
            </button>
          </div>
