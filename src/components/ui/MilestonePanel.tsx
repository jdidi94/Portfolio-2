        ...
        >
          ...
          <div className="flex shrink-0 justify-end border-t border-white/10 px-4 py-3">
            <button
              ...
              className="rounded-sm border border-white/15 bg-black/40 px-3 py-1.5 text-xs tracking-wide text-white/80 transition hover:border-white/30 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-300/70"
            >
              Close
            </button>
          </div>
